...
namespace Presentacion.Controllers
{
    public class ReportesController : Controller
    {
        ...
        public string ReporteTarjetasPorEmpleado()
        {
            ...
            chart.InitChart(new DotNet.Highcharts.Options.Chart { DefaultSeriesType = DotNet.Highcharts.Enums.ChartTypes.Column });
        ...
        public string ReporteTarjetasAnuales()
        {
          
            BLL.BLLHistoricoSolicitudTarjeta bll = new BLL.BLLHistoricoSolicitudTarjeta();

            var hist = bll.ObtenerHistoricoSolicitudTarjetasPorAño();

            Highcharts chart = new DotNet.Highcharts.Highcharts("Cantidad de patos en Australia");

            chart.SetTitle(new Title()
            {
                Text = "Cantidad de ventas anuales"
            });
