...
namespace SL
{
    ...
    {
        public bool WriteErrorLog(string LogMessage, string exString)
        {
            bool Status = false;
            string LogDirectory = "C:/SGT/LOGS";
            ...
            lock (typeof(ErrorLogger))
            {
                ...
                try
                {
                    ...
                    oStreamWriter.WriteLine("Exception String: " + exString);
                    Status = true;
                }
                catch
                {
        ...
        private string BuildLogLine(DateTime CurrentDateTime, string LogMessage)
        {
            ...
            loglineStringBuilder.Append("Mensaje: ");
